...
const headCells = [
  ...
  { id: 'phoneNumber', numeric: false, disablePadding: true, label: translate('client.phone') },
...
export default function EnhancedTable(props) {
  ...
  const handleDelete = () => {
    props.requestDeleteClient(deleted);
  }
  const filteredClients = props.filteredClients;
  const rows = filteredClients.length > 0 ? filteredClients : props.client;
