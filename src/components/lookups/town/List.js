...
const headCells = [
  ...
  { id: 'cityId', numeric: false, disablePadding: true, label: translate('city.city') },
...
export default function EnhancedTable(props) {
  ...
  const handleDelete = () => {
    props.requestDeleteTown(deleted);
  }
  const rows = props.town;
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align={"center"}>
                          {props.isRTL ? row.cityNameAr:row.cityName}
                        </TableCell>
                        <TableCell align={"center"}>
                          {isAuthenticated()?(<div>
                          <Tooltip title={translate('common.delete')}>
