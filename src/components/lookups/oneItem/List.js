...
import { translate ,isRTL} from "./../../../util/translate";
...
const headCells = [
  ...
  { id: 'code', numeric: false, disablePadding: true, label: translate('item.code') },
  { id: 'price', numeric: false, disablePadding: true, label: translate('item.price') },
  { id: 'quantity', numeric: false, disablePadding: true, label: translate('item.quantity') },
  { id: 'colorId', numeric: false, disablePadding: true, label: translate('color.color') },
  { id: 'sizeId', numeric: false, disablePadding: true, label: translate('size.size') },
  { id: 'itemId', numeric: false, disablePadding: true, label: translate('item.item') },
...
export default function EnhancedTable(props) {
  ...
  const handleDelete = () => {
    props.requestDeleteOneItem(deleted);
  }
  const rows = props.oneItem;
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align={"center"}>
                          {props.isRTL ? row.colorNameAr:row.colorName}
                        </TableCell>
                        <TableCell align={"center"}>
                          {props.isRTL ? row.sizeNameAr:row.sizeName}
                        </TableCell>
                        <TableCell align={"center"}>
                          {row.itemName}
                        </TableCell>
